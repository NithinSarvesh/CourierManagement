-- ==========================================================
-- COURIER MANAGEMENT SYSTEM - ORACLE DATABASE SCHEMA DDL
-- ==========================================================

-- Drop existing tables (in reverse dependency order)
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE DELIVERY_ATTEMPT CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE TRACKING_EVENT CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE PARCEL CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE CASH_MODE CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE CARD_MODE CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE ONLINE_MODE CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE COURIER_SERVICE CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE CUSTOMER_SUPPORT CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE ACCOUNTANT CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE DELIVERY_BOY CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE BRANCH_STAFF CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
/
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE COURIER CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
CREATE TABLE MANAGER (
    staff_id NUMBER PRIMARY KEY,
    manager_id NUMBER,
    CONSTRAINT fk_mgr_staff FOREIGN KEY (staff_id) REFERENCES STAFF(staff_id) ON DELETE CASCADE
);

CREATE TABLE CUSTOMER_SUPPORT (
    staff_id NUMBER PRIMARY KEY,
    staff_timing VARCHAR2(50),
    CONSTRAINT fk_cs_staff FOREIGN KEY (staff_id) REFERENCES STAFF(staff_id) ON DELETE CASCADE
);

CREATE TABLE ACCOUNTANT (
    staff_id NUMBER PRIMARY KEY,
    qualification VARCHAR2(100),
    CONSTRAINT fk_acc_staff FOREIGN KEY (staff_id) REFERENCES STAFF(staff_id) ON DELETE CASCADE
);

CREATE TABLE DELIVERY_BOY (
    courier_id NUMBER PRIMARY KEY,
    area_assigned VARCHAR2(100),
    CONSTRAINT fk_db_courier FOREIGN KEY (courier_id) REFERENCES COURIER(courier_id) ON DELETE CASCADE
);

CREATE TABLE BRANCH_STAFF (
    courier_id NUMBER PRIMARY KEY,
    department VARCHAR2(100),
    CONSTRAINT fk_bs_courier FOREIGN KEY (courier_id) REFERENCES COURIER(courier_id) ON DELETE CASCADE
);

CREATE TABLE DRIVER (
    courier_id NUMBER PRIMARY KEY,
    license_no VARCHAR2(50),
    CONSTRAINT fk_dr_courier FOREIGN KEY (courier_id) REFERENCES COURIER(courier_id) ON DELETE CASCADE
);

CREATE TABLE CASH_MODE (
    payment_id NUMBER PRIMARY KEY,
    CONSTRAINT fk_cash_payment FOREIGN KEY (payment_id) REFERENCES PAYMENT(payment_id) ON DELETE CASCADE
);

CREATE TABLE CARD_MODE (
    payment_id NUMBER PRIMARY KEY,
    CONSTRAINT fk_card_payment FOREIGN KEY (payment_id) REFERENCES PAYMENT(payment_id) ON DELETE CASCADE
);

CREATE TABLE ONLINE_MODE (
    payment_id NUMBER PRIMARY KEY,
    CONSTRAINT fk_online_payment FOREIGN KEY (payment_id) REFERENCES PAYMENT(payment_id) ON DELETE CASCADE
);

-- 13. SEQUENCES (For Auto-Increment Primary Keys)
...
-- 15. PL/SQL STORED PROCEDURES & FUNCTIONS
